...
def upgrade() -> None:
    ...
    op.add_column("users", sa.Column("external_id", sa.String(255), nullable=True, unique=True))
    op.add_column("users", sa.Column("external_provider", sa.String(50), nullable=True))
    op.add_column(
        "users", sa.Column("is_external", sa.Boolean(), nullable=False, server_default="false")
    )
